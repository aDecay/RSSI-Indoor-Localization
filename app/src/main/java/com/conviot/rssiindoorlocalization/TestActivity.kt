...
class TestActivity : ComponentActivity() {
    ...
    private var localizationTested = false
    private var localizationX = 0f
    private var localizationY = 0f
    ...
    fun DataCollector(
        ...
        Column(
            ...
            // 테스트 버튼 표시
            LocalizationTestButton("테스트", dataCollectViewModel, Modifier.width(200.dp))
        }
    }
    ...
    fun LocalizationTestButton(
        ...
        Button(
            onClick = { testLocalization(dataCollectViewModel) },
            modifier = modifier
        ) {
            Text(text = text)
        }
